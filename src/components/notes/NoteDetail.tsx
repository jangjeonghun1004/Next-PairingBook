...
const NoteDetail = ({
  ...
  if (!note) {
    return (
      <div className="bg-gray-800 rounded-lg p-6 flex flex-col items-center justify-center h-64 text-gray-400">
        <p>선택된 쪽지가 없습니다.</p>
  ...
  try {
    ...
    return (
      <div className="bg-gray-800 rounded-lg overflow-hidden flex flex-col max-h-[calc(100vh-180px)] md:max-h-none">
        {/* 쪽지 정보 헤더 - 고정 위치 */}
          ...
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="flex items-center gap-2 flex-shrink-0 ml-2">
              {isReceived && (
                <button
                  onClick={handleReply}
                  className="p-1.5 rounded-md hover:bg-indigo-900/50 text-indigo-400 flex items-center gap-1"
                  title="답장"
              ...
              <button
                ...
                className="p-1.5 rounded-md hover:bg-gray-700 text-red-400"
                title="삭제"
    ...
    return (
      <div className="bg-gray-800 rounded-lg p-6 flex flex-col items-center justify-center h-64 text-red-400">
